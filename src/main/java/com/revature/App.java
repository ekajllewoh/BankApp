	...
	public static void run() {
		...
		if (input == 1) {
			...
			if (loggedInUser.getRole() == Role.Customer) {
				...
				System.out.println(
						"If you would like to open an account press 1, if you would like to view your accounts press 2. Press 0 to close.");
				...
				System.out.println(
						"Press 1 to view all accounts, or press 2 to approve/deny a specific account. Press 0 to end.");
				...
				while (nextCheck != 0)
					System.out.println(
							"Please enter 1 to view all accounts, 2 to access a specific account. Press 0 to exit.");
